...
2. `AZURE_FORMRECOGNIZER_RESOURCE_GROUP=""`
3. `AZURE_FORMRECOGNIZER_SERVICE=""`
4. `AZURE_LOCATION="westeurope"`
5. `AZURE_OPENAI_CHATGPT_DEPLOYMENT=""`
6. `AZURE_OPENAI_CHATGPT_MODEL=""`
7. `AZURE_OPENAI_EMB_DEPLOYMENT=""`
8. `AZURE_OPENAI_EMB_MODEL_NAME=""`
9. `AZURE_OPENAI_RESOURCE_GROUP=""`
10. `AZURE_OPENAI_SERVICE=""`
11. `AZURE_RESOURCE_GROUP=""`
12. `AZURE_SEARCH_ANALYZER_NAME=""`
13. `AZURE_SEARCH_INDEX=""`
14. `AZURE_SEARCH_QUERY_LANGUAGE=""`
15. `AZURE_SEARCH_QUERY_SPELLER=""`
16. `AZURE_SEARCH_SERVICE=""`
17. `AZURE_SEARCH_SERVICE_RESOURCE_GROUP=""`
18. `AZURE_STORAGE_ACCOUNT=""`
19. `AZURE_STORAGE_CONTAINER=""`
20. `AZURE_STORAGE_RESOURCE_GROUP=""`
21. `AZURE_SUBSCRIPTION_ID=""`
22. `AZURE_TENANT_ID=""`
23. `AZURE_USE_APPLICATION_INSIGHTS=""`
24. `BACKEND_URI=""`
25. `OPENAI_API_KEY=""`
26. `OPENAI_HOST="azure"`
27. `OPENAI_ORGANIZATION=""`
New
28. `MAX_SECTION_LENGTH=""`
29. `SENTENCE_SEARCH_LIMIT=""`
30. `SECTION_OVERLAP=""`
31. `AZURE_SEARCH_KEY=""`
32. `AZURE_SEARCH_SERVICE_CATEGORY=""`
...
36. `AZURE_LOG_ANALYTICS=""`
37. `AZURE_APP_INSIGHT=""`
38. `AZURE_INBOUND_STORAGE_CONTAINER=` 
39. `AZURE_INBOUND_DOC_STORAGE_ACCOUNT_KEY=`