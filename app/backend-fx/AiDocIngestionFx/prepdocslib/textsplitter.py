...
class TextSplitter:
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.word_breaks = [",", ";", ":", " ", "(", ")", "[", "]", "{", "}", "\t", "\n"]
        self.max_section_length = int(os.environ["MAX_SECTION_LENGTH"]) #1000 
        self.sentence_search_limit = int(os.environ["SENTENCE_SEARCH_LIMIT"]) #100
        self.section_overlap = int(os.environ["SECTION_OVERLAP"]) #100
